...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/Alex13-th/azure_task_12_deploy_app_with_vm_extention/develop/install-app.sh'); commandToExecute = './install-app.sh'}
}
